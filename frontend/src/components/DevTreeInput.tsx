...
type DevTreeInputProps = {
    ...
    handleSwitchChange: (social: string) => void
}

export default function DevTreeInput({item, handleUrlChange, handleSwitchChange}: DevTreeInputProps) {

    return (
        <div className='bg-white shadow-sm p-5 flex items-cente gap-3'>
